...
| 1-2a | DINOv3 백본 래퍼 | ✅ 완료·검토대기 (2026-04-24) | [phase1-2a_backbone.md](phase1-2a_backbone.md) | HF AutoModel lazy-load + patch grid · 36 pytest green (3 gated skip) |
| 1-2b | DETR head 학습 | ⚪ 예정 | — | 백본 freeze→unfreeze · COCO mAP 베이스라인 |
